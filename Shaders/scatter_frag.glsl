...
vec3 inscatter(vec3 near, vec3 far, vec3 direction){
...
if(!intersect_detect(samplePoint, -light_direction, earth_center, earth_radius)){
float height = length(samplePoint - earth_center) - earth_radius;
...
if(intersect_detect(vec3(0.0), direction, earth_center, earth_radius)){
